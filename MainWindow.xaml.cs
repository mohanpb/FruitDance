...
namespace ShapeGame
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const double MinShapeSize = 30;         // from 12
        private const double MaxShapeSize = 60;         // from 90
        ...
        private void WindowLoaded(object sender, EventArgs e)
        {
            ...
            FlyingText.NewFlyingText(this.screenRect.Width / 30, new Point(this.screenRect.Width / 2, this.screenRect.Height / 2), "Start Slicing!!!");
        }
        ...
        private void HandleGameTimer(int param)
        {
            ...
            for (int i = 0; i < NumIntraFrames; ++i)
            {
                ...
                this.myFallingThings.AdvanceFrame(this.playfield.Children);
            }
