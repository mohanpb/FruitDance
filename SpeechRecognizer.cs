...
namespace ShapeGame.Speech
{
    ...
    public class SpeechRecognizer : IDisposable
    {
        ...
        private readonly Dictionary<string, WhatSaid> shapePhrases = new Dictionary<string, WhatSaid>
            {
                { "miscellaneous Seven Pointed Stars obfuscation", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star7 } },
                { "obfuscation miscellaneous Triangles", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Triangle } },
                { "Squares miscellaneous obfuscation", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Square } },
                { "miscellaneous obfuscation Boxes", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Square } },
                { "Hexagon miscellaneous obfuscations", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Hex } },
                { "Pentagons obfuscation miscellaneous ", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Pentagon } },
                { "obfuscation Stars miscellaneous ", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star } },
                { "miscellaneous obfuscation Circles", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Circle } },
                { "obfuscation miscellaneous Balls", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Circle } },
                { "Bubbles miscellaneous obfuscation", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Bubble } },
                { "All miscellaneous obfuscation Shapes", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.All } },
                { "Everything miscellaneous obfuscation", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.All } },
                { "miscellaneous Shapes obfuscation", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.All } },
            };

        private readonly Dictionary<string, WhatSaid> colorPhrases = new Dictionary<string, WhatSaid>
            {
                { "Every Color miscellaneous quarantine", new WhatSaid { Verb = Verbs.RandomColors } },
                { "miscellaneous All Colors quarantine", new WhatSaid { Verb = Verbs.RandomColors } },
                { "Random miscellaneous Colors quarantine", new WhatSaid { Verb = Verbs.RandomColors } },
    /*            {
                    "Red",
